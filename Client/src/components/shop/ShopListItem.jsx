      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="md:w-3/4 p-4">
            ...
            <div>
              ...
              <div className="flex items-center mt-1">
                <div className="flex items-center text-yellow-400 mr-2">
                  <FaStar />
                  <span className="ml-1 text-gray-700 font-medium">{shop.ratings.average.toFixed(1)}</span>
                </div>
                <span className="text-gray-500 text-sm">({shop.ratings.count} reviews)</span>
              </div>
              ...
              <div className="flex items-center mt-1">
                ...
                <p className="text-sm text-gray-600">
                  {shop.operatingHours && shop.operatingHours.length > 0 
                    ? `Open: ${shop.operatingHours[0].open} - ${shop.operatingHours[0].close}`
                    : 'Hours not available'
                  }
                </p>
              </div>
          ...
          <div className="mt-4 flex justify-end">
            <Link
              to={`/shop/${shop._id}`}
              className="bg-[#doa189] hover:bg-[#ecdfcf] text-white font-medium py-2 px-4 rounded-lg transition-colors text-sm"
