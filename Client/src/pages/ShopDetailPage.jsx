...
const ShopDetailPage = () => {
  ...
  const handleShareClick = () => {
    if (navigator.share) {
      navigator.share({
        title: shop.name,
        text: `Check out ${shop.name} on Beauty & Wellness Booking Platform`,
    ...
    <div className="bg-[#fef4ea] min-h-screen">
      ...
      <div className="relative shop-header">
        <div className="h-64 md:h-80 overflow-hidden">
          <img 
            src={shop.gallery[0]?.url || '/images/default-shop-cover.jpg'} 
            alt={shop.name} 
          ...
          <div className="relative -mt-20 bg-white rounded-lg shadow-md p-6 mb-6">
            <div className="flex flex-col md:flex-row md:items-center">
              <div className="w-24 h-24 md:w-32 md:h-32 rounded-lg overflow-hidden border-4 border-white shadow-md -mt-16 md:-mt-24 mb-4 md:mb-0 md:mr-6">
                <img 
                  src={shop.gallery[0]?.url || '/images/default-shop-logo.jpg'} 
                  alt={shop.name} 
                  className="w-full h-full object-cover"
                />
              </div>
              ...
              <div className="flex-grow">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                  <div>
                    <h1 className="text-2xl md:text-3xl font-bold text-[#a38772]">{shop.name}</h1>
                    ...
                    <div className="flex items-center mb-2">
                      <div className="flex text-yellow-400 mr-2">
                        {[...Array(5)].map((_, i) => (
                          <span key={i}>
                            {i < Math.floor(shop.ratings.average) ? (
                              <FaStar />
                            ) : i < Math.ceil(shop.ratings.average) ? (
                      ...
                      <span className="text-[#a38772] font-semibold">{shop.ratings.average.toFixed(1)}</span>
                      <span className="text-gray-500 ml-1">({shop.ratings.count} reviews)</span>
                    </div>
                  ...
                  <div className="flex mt-4 md:mt-0">
                    <button
                      ...
                      className="flex items-center justify-center bg-white border border-[#doa189] text-[#doa189] py-2 px-4 rounded-lg mr-2 hover:bg-[#fef4ea] transition-colors"
                    >
          ...
          <div className="lg:col-span-2">
            <Tabs className="mb-8">
              <TabList className="flex bg-white rounded-t-lg overflow-hidden">
                <Tab className="flex-1 py-3 px-4 text-center cursor-pointer border-b-2 border-transparent hover:bg-[#fef4ea] transition-colors focus:outline-none" selectedClassName="border-[#doa189] bg-[#fef4ea] font-semibold text-[#a38772]">
                  Services
                </Tab>
                <Tab className="flex-1 py-3 px-4 text-center cursor-pointer border-b-2 border-transparent hover:bg-[#fef4ea] transition-colors focus:outline-none" selectedClassName="border-[#doa189] bg-[#fef4ea] font-semibold text-[#a38772]">
                  Gallery
                ...
                <Tab className="flex-1 py-3 px-4 text-center cursor-pointer border-b-2 border-transparent hover:bg-[#fef4ea] transition-colors focus:outline-none" selectedClassName="border-[#doa189] bg-[#fef4ea] font-semibold text-[#a38772]">
                  Reviews <span className="text-sm">({shop.ratings.count})</span>
                </Tab>
                <Tab className="flex-1 py-3 px-4 text-center cursor-pointer border-b-2 border-transparent hover:bg-[#fef4ea] transition-colors focus:outline-none" selectedClassName="border-[#doa189] bg-[#fef4ea] font-semibold text-[#a38772]">
                  About
                </Tab>
              ...
              <TabPanel>
                <div className="bg-white rounded-b-lg p-6">
                  <h2 className="text-xl font-bold text-[#a38772] mb-6">Our Services</h2>
              ...
              <TabPanel>
                <div className="bg-white rounded-b-lg p-6">
                  <h2 className="text-xl font-bold text-[#a38772] mb-6">Gallery</h2>
              ...
              <TabPanel>
                <div className="bg-white rounded-b-lg p-6">
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
                    ...
                    <Link
                      to={isAuthenticated ? `/shop/${shopId}/write-review` : '/login'}
                      className="mt-2 md:mt-0 inline-block bg-[#doa189] hover:bg-[#ecdfcf] text-white font-semibold py-2 px-4 rounded-lg transition-colors"
                      onClick={(e) => {
                        if (!isAuthenticated) {
                          e.preventDefault();
                  ...
                  <div className="flex flex-col md:flex-row bg-[#fef4ea] rounded-lg p-4 mb-6">
                    <div className="md:w-1/4 mb-4 md:mb-0 flex flex-col items-center justify-center">
                      ...
                      <div className="text-gray-600">
                        Based on {shop.ratings.count} reviews
                      </div>
                    </div>
                    ...
                    <div className="md:w-3/4 md:pl-6">
                      ...
                      {[5, 4, 3, 2, 1].map(rating => {
                        ...
                        const percentage = shop.ratings.count > 0 
                          ? (count / shop.ratings.count) * 100 
                          : 0;
                  ...
                  {reviews.length > 0 && (
                    <div className="text-center mt-6">
                      <Link
                        ...
                        className="inline-block bg-white border border-[#doa189] text-[#doa189] font-semibold py-2 px-6 rounded-lg hover:bg-[#fef4ea] transition-colors"
                      >
                        View All Reviews
                      </Link>
                    </div>
              ...
              <TabPanel>
                <div className="bg-white rounded-b-lg p-6">
                  <h2 className="text-xl font-bold text-[#a38772] mb-6">About Us</h2>
                    ...
                    <div>
                      ...
                      <ul className="space-y-3">
                        ...
                        <li className="flex items-center">
                          <FaPhone className="text-[#doa189] mr-3" />
                          <a href={`tel:${shop.contactInfo.phone}`} className="text-gray-700 hover:text-[#doa189]">
                        ...
                        <li className="flex items-center">
                          ...
                          <a href={`mailto:${shop.contactInfo.email}`} className="text-gray-700 hover:text-[#doa189]">
                        ...
                        {shop.contactInfo.website && (
                          <li className="flex items-center">
                            <FaGlobe className="text-[#doa189] mr-3" />
                            <a 
                              href={shop.contactInfo.website} 
                              target="_blank" 
                              rel="noopener noreferrer"
                              className="text-gray-700 hover:text-[#doa189]"
                            >
                              {shop.contactInfo.website}
                            </a>
                          </li>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-600 mb-4">
                Select a service from our menu and book your appointment at a time that suits you.
              </p>
              
              <button
                onClick={() => setIsBookingModalOpen(true)}
                className="w-full flex items-center justify-center bg-[#doa189] hover:bg-[#ecdfcf] text-white font-bold py-3 px-4 rounded-lg transition-colors"
              >
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <a
                href={`https://maps.google.com/?q=${shop.address.coordinates.lat},${shop.address.coordinates.lng}`}
                target="_blank"
                rel="noopener noreferrer"
                className="w-full block text-center bg-white border border-[#doa189] text-[#doa189] font-semibold py-2 px-4 rounded-lg hover:bg-[#fef4ea] transition-colors"
              >
                Get Directions
              </a>
            </div>
