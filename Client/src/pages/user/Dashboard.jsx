...
console.log("getFavorites", getFavoriteShops());
const UserDashboard = () => {
  const { user } = useAuth();
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="dashboard-card bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center">
              <div className="w-12 h-12 rounded-full bg-[#d0a189] bg-opacity-20 flex items-center justify-center mr-4">
                <FaCalendarAlt className="text-[#d0a189] text-xl" />
              </div>
              <div>
          ...
          <div className="dashboard-card bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center">
              <div className="w-12 h-12 rounded-full bg-[#d0a189] bg-opacity-20 flex items-center justify-center mr-4">
                <FaHeart className="text-[#d0a189] text-xl" />
              </div>
              <div>
          ...
          <div className="dashboard-card bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center">
              <div className="w-12 h-12 rounded-full bg-[#d0a189] bg-opacity-20 flex items-center justify-center mr-4">
                <FaWallet className="text-[#d0a189] text-xl" />
              </div>
              <div>
        ...
        <div className="dashboard-card bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          {upcomingAppointments.length > 0 ? (
            ...
            <div className="text-center py-8">
              ...
              <Link
                to="/shops"
                className="inline-block bg-[#d0a189] hover:bg-[#ecdfcf] text-[#a27947] border-x-2 hover:text-[#a38772] font-medium py-2 px-6 rounded-lg transition-colors"
              >
                Book an Appointment
              </Link>
            </div>
                ...
                <ShopCard
                  ...
                  onFavoriteToggle={async () => {
                    try {
                      ...
                      setFavoriteShops(res.data?.data || []);
                    } catch (err) {
                      console.error("Failed to refresh favorite shops:", err);
                      toast.error("Failed to refresh favorite shops.");
                    }
                  }}
                />
              ))}
        ...
        <div className="dashboard-card bg-white rounded-lg shadow-md p-6">
          ...
          <div className="flex flex-col md:flex-row ">
            <div className="md:w-1/4 mb-6 md:mb-0 flex flex-col items-center">
              <div className="w-24 h-24 rounded-full overflow-hidden bg-[#d0a189] flex items-center justify-center mb-3 border-x-2 border-[#a38772]">
              ...
              <Link
                to="/user/profile"
                className="text-[#d0a189] text-sm hover:underline"
              >
                Change Photo
              </Link>
            </div>
